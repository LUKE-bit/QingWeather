...
import com.qingweather.android.logic.dao.PlaceDao
import com.qingweather.android.logic.model.Place
import com.qingweather.android.logic.model.Weather
    ...
    fun refreshWeather(lng:String,lat:String) = fire(Dispatchers.IO) {
        coroutineScope {
            val deferredRealtime = async {
                QingWeatherNetwork.getRealtimeWeather(lng, lat)
            }
            val deferredDaily = async {
                QingWeatherNetwork.getDailyWeather(lng, lat)
            }
